...
int main(int argc, char** argv) {
    ...
    cout<<"The second car's mileage is "<<mileag2<<" miles per gallon"<<endl;
    //Calculate which car has best fuel efficiency
    efficnt(mileag1, mileag2);
...
float efficnt(float mileag1,float mileag2){
    if(mileag1>mileag2){
